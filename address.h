...
namespace pkodev
{
	namespace address
	{
        ...
        namespace GAME_13X_0
        {
            ...
            const unsigned int patch__0 = 0x004A3DDF;
            ...
            const unsigned int patch__1 = 0x004A4363;
        }
        ...
        namespace GAME_13X_1
        {
            ...
            // ->
            // [51 8B CE E8 XX XX XX XX 59 84 C0 74 16 90 90 90 90 90 90 90 90 90 90 90 90 90 90]
            const unsigned int patch__0 = 0x004A3EEF;

            // Patch 2 address
            // [3D 80 00 00 00 7C 46 3D 8C 00 00 00 7F 3F 3D 87 00 00 00 74 38]
            // ->
            // [51 8B CE E8 XX XX XX XX 59 84 C0 74 40 90 90 90 90 90 90 90 90]
            const unsigned int patch__1 = 0x004A4473;
        }
        ...
        namespace GAME_13X_2
        {
            ...
            // ->
            // [51 8B CE E8 XX XX XX XX 59 84 C0 74 16 90 90 90 90 90 90 90 90 90 90 90 90 90 90]
            const unsigned int patch__0 = 0x004A3F8F;

            // Patch 2 address
            // [3D 80 00 00 00 7C 46 3D 8C 00 00 00 7F 3F 3D 87 00 00 00 74 38]
            // ->
            // [51 8B CE E8 XX XX XX XX 59 84 C0 74 40 90 90 90 90 90 90 90 90]
            const unsigned int patch__1 = 0x004A4513;
        }
        ...
        namespace GAME_13X_3
        {
            ...
            // ->
            // [51 8B CE E8 XX XX XX XX 59 84 C0 74 16 90 90 90 90 90 90 90 90 90 90 90 90 90 90]
            const unsigned int patch__0 = 0x004A3F7F;

            // Patch 2 address
            // [3D 80 00 00 00 7C 46 3D 8C 00 00 00 7F 3F 3D 87 00 00 00 74 38]
            // ->
            // [51 8B CE E8 XX XX XX XX 59 84 C0 74 40 90 90 90 90 90 90 90 90]
            const unsigned int patch__1 = 0x004A4503;
        }
        ...
        namespace GAME_13X_4
        {
            ...
            // ->
            // [51 8B CE E8 XX XX XX XX 59 84 C0 74 16 90 90 90 90 90 90 90 90 90 90 90 90 90 90]
            const unsigned int patch__0 = 0x004A41BF;

            // Patch 2 address
            // [3D 80 00 00 00 7C 46 3D 8C 00 00 00 7F 3F 3D 87 00 00 00 74 38]
            // ->
            // [51 8B CE E8 XX XX XX XX 59 84 C0 74 40 90 90 90 90 90 90 90 90]
            const unsigned int patch__1 = 0x004A4743;
        }
        ...
        namespace GAME_13X_5
        {
            ...
            // ->
            // [51 8B CE E8 XX XX XX XX 59 84 C0 74 16 90 90 90 90 90 90 90 90 90 90 90 90 90 90]
            const unsigned int patch__0 = 0x004A3C11;

            // Patch 2 address
            // [3D 80 00 00 00 7C 46 3D 8C 00 00 00 7F 3F 3D 87 00 00 00 74 38]
            // ->
            // [51 8B CE E8 XX XX XX XX 59 84 C0 74 40 90 90 90 90 90 90 90 90]
            const unsigned int patch__1 = 0x004A4193;
        }
	}
}